...
`;
 ...
 app.ws('/api/live/ws/live/process-stream', async (ws, req) => {
  ...
  try {
   ...
   const model = "gemini-live-2.5-flash-native-audio"; // "gemini-2.0-flash-001"; // "gemini-live-2.5-flash-preview" //"gemini-2.5-flash-live-preview"; // Hackathon standard is usually gemini-2.0-flash-exp
