...
echo "window.runtimeConfig = { BACKEND_URL: '${REACT_APP_BACKEND_URL}' };" > /usr/share/nginx/html/config.js

echo "Generated config.js with backend URL: ${REACT_APP_BACKEND_URL}"
