    ...
    <div className="flex flex-col items-center justify-center min-h-screen p-6 animate-in fade-in">
      ...
      <div className="w-full max-w-xl flex flex-col space-y-8">
        ...
        <button 
          ...
          className="w-full bg-blue-800 text-white text-4xl font-extrabold py-8 rounded-2xl shadow-xl hover:bg-blue-900 mt-8"
        >
          Login
        </button>
  ...
  const renderSignup = () => (
    <div className="flex flex-col items-center justify-center min-h-screen p-6 animate-in fade-in">
      ...
      <div className="w-full max-w-xl flex flex-col space-y-6">
        ...
        <button 
          onClick={() => setCurrentScreen('dashboard')}
          className="w-full bg-blue-800 text-white text-4xl font-extrabold py-8 rounded-2xl shadow-xl hover:bg-blue-900 mt-6"
        >
          Sign Up
        </button>
      ...
      <div className="w-full max-w-2xl flex flex-col space-y-8">
        ...
        <div className="flex flex-col space-y-6 pt-6">
          <button 
            ...
            className="w-full bg-green-700 text-white text-4xl font-extrabold py-8 rounded-2xl shadow-xl hover:bg-green-800 border-4 border-green-800"
          >
            Save Photo
          </button>
